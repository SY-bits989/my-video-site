...
export type VideoItem = {
  title: string;
  url?: string;           // 普通連結用
  embedCode?: string;     // 嵌入用
  desc?: string;
  image?: string;
  type?: 'link' | 'embed'; // 新增類型區分
};
...
export const videoData = {
  ...
  "audio": [
    ...
    { title: "凈泉音樂原創：雨中燈", url: "https://www.joankingmusic.com/blog/music000394", desc: "" },
  ],

  "culture": [
    { title: "看中國：這樣做 讓你的孩子愛上閱讀", url: "http://kzg.io/b54cB8", desc: "" },
    { title: "看中國：4月份三退逾120萬 比上月增3萬 歷史在等待你的名字", url: "http://kzg.io/b54buT", desc: "" },
  ],
